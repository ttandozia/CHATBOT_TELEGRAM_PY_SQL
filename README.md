...
**Important:** 
* The ".py" file with the implementation of the Bot and use of the models built in jupyter is not available here, since it was made for a client. If you want to see it in action, you can see some screenshots at the end of this MD. Also, you can send me a message so I start it for you.
